        ...
        <div class="col-xs-12">
          <div class="col-md-4">
            ...
            <select class="js-example-basic-single" name="state" id="rep_cbm_grado" style="width:100%; "
              onchange="ShowSelectedCursos_docente();">
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-4">
            ...
            <div class="alin_global">
              ...
              <button onclick="Consultar_Notas();" class="btn-sm" id="btn_bucar_data"> <em class="fa fa-search"></em>
              </button>
            </div>
        ...
        <div class="col-xs-6">
          <div class="input-group">
            <input type="text" class="global_filter form-control" id="global_filter"
              placeholder="Ingresar Nombre a buscar" autocomplete="false" style="border-radius: 5px;">
      ...
      <table class="table table-striped" id="tbl-reporNota" style=" width: 100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align='center'><label class=' form-control' id='id_aprob'><?php echo $notaFinal; ?> </label></td>

            <?php  }else{ ?>
            <td align='center'><label class=' form-control' id='id_desap'><?php echo $notaFinal; ?></label></td>
            <?php }?>
          </tr>
          <?php
                   $count++;  }
