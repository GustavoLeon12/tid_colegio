      ...
      <section>
        ...
        <form class="create__blog" id="form" enctype="multipart/form-data" method="post">
          ...
          <div class="create__blog__title mt-3">
            ...
            <input type="text" name="title" id="title" class="form-control" placeholder="Escribe un titulo...">
          </div>
  ...
  <script>
    ...
    function validator()
    {
      ...
      if (titleValue.trim().length === 0) {
        ...
        $error.textContent = "La portada no debe de estar vacío."
        return false
      } else if (contentLength < 100) {
        $error.textContent = "La noticia debe de tener 100 caracteres."
        return false
      } else {
        return true
      }
