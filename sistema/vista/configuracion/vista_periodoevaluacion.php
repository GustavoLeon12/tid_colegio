  ...
  <div class="box box-warning ">
    <div class="box-header with-border titulosclass" id="Titulo_Center">
      ...
      <div class="grup_buttons">
        <button id="buttNew" class="btn btn-warning btn-sm pull-right" onclick="Abilitar_Form_registro()"><em
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="col-md-6">
            ...
            <select class="js-example-basic-single" onchange="selecPeriodo()" name="state" id="periodovaluacion"
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary btn-sm" onclick="Registrar_pEvaluacion()" id="btn_registra" disabled><em
          class="fa fa-check"><b>&nbsp;Registrar</b></em></button> <button type="button" class="btn btn-danger btn-sm"
        onclick="LimpiarRegistroperiodo()"><em class="fa fa-close"><b>&nbsp;Cance</b></em></button>
    </div>
  </div>
</div>
...
<div class="col-md-6">
  <div class="box box-warning ">
    <div class="box-header with-border titulosclass" id="Titulo_Center">
      <h5 class="box-title">Periodos de evaluación<p id="yaernombreEv"></p>
      </h5>
      <div class="grup_buttons">
        &nbsp;&nbsp;<button id="buttEdit" type='button' class='btn btn-primary btn-sm' onclick="Editar_periodo_Eval();"
          style=""><em class='fa fa-edit' title='editar'></em></button>&nbsp;
        <button id="butt_quitar" type='button' class='btn btn-default btn-sm pull-right'
          onclick="Quitar_periodo_Eval();" style=""><em class='fa fa-trash' title='Eliminar'></em></button>
      </div>
    </div>
    <div class="box-body">
