...
<div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
  <div id='avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button
    ...
    Para configurar la fase de recuperación y la fase regular debes presionar en <em
      class="fa fa-fw fa-plus-circle"></em> y para editarlo en <em class='fa fa-edit'></em> pero las fecha deben estar
    en el rango de la fechas (F. Inicio F. Final) del año escolar activo. Si no tomo en cuenta las fechas puedes editar
  ...
  <div class="box box-warning ">
    <div class="box-header with-border titulosclass" id="Titulo_Center">
      ...
      <div class="grup_buttons">
        <button id="buttNew" class="btn btn-warning btn-sm pull-right" onclick="AbrirModalRegistro_Fase()"><em
            class="fa fa-fw fa-plus-circle"></em></button>
      </div>
    </div>
    <div class="box-body">
      <div class="row">
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary" onclick="Registrar_faseEscolar()" id="btn_registrar" disabled><em
          class="fa fa-check"><b>&nbsp;Guardar</b></em></button> <button type="button" class="btn btn-danger"
        onclick="LimpiarRegistroFase()"><em class="fa fa-close"><b>&nbsp;Cancelar</b></em></button>
    </div>
  </div>
</div>
...
<div class="col-md-6">
  <div class="box box-warning ">
    <div class="box-header with-border titulosclass" id="Titulo_Center">
      <h3 class="box-title">Fase escolar de : <p id="nombryear"></p>
      </h3>
      <div class="grup_buttons">
        <button id="buttEdit" style='font-size:13px;display: none;' type='button' class='btn btn-primary btn-sm'
          onclick="editar_Fase_Escolar()"><em class='fa fa-edit' title='editar'></em></button>&nbsp;
        <button id="butt_quitar" style='font-size:13px;display: none;' type='button'
          class='btn btn-default btn-sm pull-right' onclick="Quitar_periodo_Fase();" style=""><em class='fa fa-trash'
            title='Eliminar'></em></button>
