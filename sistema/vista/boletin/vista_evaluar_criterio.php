      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="col-md-2">
            ...
            <select class="js-example-basic-single" name="state" id="bol_cbm_year" style="width:100%;"
              onchange="SelectedConsultaLimitd();">
            </select><br><br>
          </div>
          <div class="col-md-3">
            <label for="">Grado</label>
            <input type="text" id="edit_txt_evaluacion" hidden><br>
            <select class="js-example-basic-single" name="state" id="txt_evaluacion_grado" style="width:100%;"
              onchange="ShowSelectedCursos();" disabled>
            </select><br><br>
          </div>
          <div class="col-md-3">
