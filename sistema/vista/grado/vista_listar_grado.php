    ...
    <div class="box-body">
      ...
      <div class="col-lg-12">
        ...
        <select class="js-example-basic-single" name="state" id="cbm_aula" style="width:100%;"
          onchange="ShowSelectedAluas(this);">
        </select><br><br>
      </div>
      <div class="col-lg-12">
        <label for="">Vacantes Disponibles</label>
        <input type="number" class="form-control" id="vacantes" disabled>
        <label class="control-label" id="inputWarning" style="display: none">Divide en 2 secciones si tienes más
          vacantes </label>
      </div>
    </div>
    <div class="modal-footer">
      <button class="btn btn-primary btn-sm" id="btn-register" onclick="Registrar_Grado()"><i
          class="fa fa-check"><b>&nbsp;Registrar</b></i></button>
      <button type="button" class="btn btn-default btn-sm" onclick="Cancelar_Registro()" data-dismiss="modal"><i
