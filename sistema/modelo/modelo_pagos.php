...
where yeayid ='$yearid'";
  ...
  function listar_Reportes_PorFechas($finicio, $fFinal)
  {
    $sql = "select idalumno, apellidos, alumnonombre,tipo, fechasPagados, motoPago FROM registopagos
 inner join  alumno on alumno.idalumno = registopagos.alumno_id 
      WHERE dateoperation BETWEEN '$finicio' and '$fFinal'";
