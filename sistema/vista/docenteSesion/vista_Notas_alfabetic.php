...
<div class="col-md-12" id="Div_boletaNotas" style="display: none">
  <div class="box box-warning ">
    <div class="box-header with-border">
      <div class="col-xs-2">
        <a onclick="Black_MenuAsis();">&nbsp;<i class="fa fa-chevron-circle-left fa-2x" aria-hidden="true"
            style="color: #3894c9"></i></a>
      </div>
      <h3 class="box-title" style="text-align: center;"><strong>Calificaciones finales alfabéticos (A,B,C) </strong>
      </h3>
    </div>
    <!-- /.box-header -->
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-4">
            ...
            <div class="alin_global">
              ...
              &nbsp;
              <button onclick="Extraer_Notas_Curso_Year();" class="btn btn-primary" id="btn_bucar_data"
                class="btn btn-flat">
