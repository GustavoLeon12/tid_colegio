  ...
  <div class="box box-warning ">
    <div class="box-header titulosclass" id="Titulo_Center">
      ...
      <div class="box-tools pull-right">
        <button type="button" onclick="Cancelar_registro();" class="btn btn-box-tool" data-widget="collapse"><em
    ...
    <div class="box-body">
      <div class="col-lg-12">
        ...
        <div class="col-lg-12" style='border-color: #f5c6cb;'>
          ...
          <div id="error_avisomanual" class="alert  sm" role="alert"
            style="color: #721c24; background-color: #f8d7da; display: none">
        ...
        <div class="row">
          ...
          <div class="col-xs-2">
            <button class="btn  btn-warning btn-sm" id="add_cursos_btn" onclick="Add_tr_table()"><em
    ...
    <div class="modal-footer">
      <button class="btn btn-primary btn-sm " onclick="Registrar_Cursogrado()"><i
  ...
  <div class="box box-warning ">
    ...
    <div class="box-body">
      <div class="col-lg-12">
        ...
        <div class="col-lg-12" style='border-color: #f5c6cb;'>
          <div id="table_avisomanua" class="alert  sm" role="alert" style="color: #0e0102; background-color: #accbef;">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
