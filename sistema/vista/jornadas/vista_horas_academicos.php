...
<div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
  <div id='avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button
      type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    Para crear horas laborales seleccione el año académico activo en seguida se listaran turnos del año académico
    configurado…seleccione un turno,( Primero registre un turno luego vuelve por el otro.. ) las horas automáticamente
    se mostraran ya que se han configura al crear el año académico ..en seguida ingrese hora entre el inicio y final y
    presione en el botón <em class="glyphicon glyphicon-plus"></em> para agregar a la lista…por ultimo seleccione el
    grado y nivel…Gracias por su atención.
  </div>
</div>
      ...
      <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-xs-2 but_New">
            <button class="btn btn-primary" style="width:100%" onclick="From_registro_horas()"><em
...
<div class="col-md-12" id="DivFromJornadas" style="display: none;">
  <div class="box box-warning ">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="col-md-3">
            ...
            <select class="js-example-basic-single" name="state" id="cbm_year" style="width:100%;"
              onchange="ShowSelected_Anio();">
            </select><br><br>
          </div>
          <div class="col-md-3">
            <label for="">Jornada || Tunos</label>
            <select class="js-example-basic-single" name="state" id="combo_turnos" style="width:100%;" disabled
              onchange="Selected_Horas_Turno();">
            </select><br><br>

          </div>
          <div class="col-md-3">
            <label for="">Hora de Inicio Jornada</label>
            <input type="time" class="form-control" id="iniciofornada" placeholder="" style="border-radius: 5px;"
              disabled><br>
          </div>
          <div class="col-md-3">
            <label for="">Hora Final Jornada</label>
            <input type="time" class="form-control" id="finalfornada" style="border-radius: 5px;"
              placeholder=" Ingrese Hora" disabled><br>
          </div>
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-3">
            ...
            <select class="js-example-basic-single" name="state" id="cbm_niveles" style="width:100%;"
              onchange="Selected_Turnos_Grado();">
            </select><br><br>
          </div>
          <div class="col-md-3">
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary btn-sm" id="btn_registra" onclick="Registrar_Fornadas();"><i
          class="fa fa-check"><b>&nbsp;Guardar</b></i></button>

      <button type="button" class="btn btn-danger btn-sm" onclick="CancelarJornadas()"><i
          ...
          <div class="box-body no-padding">
            <table class="table table-condensed">
              <tbody>
                ...
                <tr>
                  <td>
                    <p id="jornada_turnos"></p>
                  </td>
                  <td>
                    <p id="grado_jornada"></p>
                  </td>
                  <td>
                    <p id="nivel_jornada"></p>
                  </td>
                </tr>
              </tbody>
            </table>
