<style>
.z-index-custom {
  z-index: 5000000000; /* El valor del z-index que deseas aplicar */
}
.swal-modal {
  z-index: 5000000000 !important; /* Valor mayor que el z-index del modal */
}
            ...
            <div>
              ...
              <div class="modal__create__form">
                <div class="input__container">
                  ...
                  <input type="number" id="stockInicial" value="0" class="form-control" required />
                </div>
                <div class="input__container">
                  <label for="stockMinimo">Stock Minimo</label>
                  <input type="text" id="stockMinimo" class="form-control" required />
                </div>
              </div>
          </div>
            <div class="">
              ...
              <div class="modal__create__form">
                <div class="input__container">
                  ...
                  <input type="number" id="precioFinal" class="form-control" required />
                </div>
                <div class="input__container">
                  <label for="fechaVencimiento">Fech. vencimiento</label>
...
<div class="col-md-12">
  <div class="box box-warning" id="content">
    <div class="box-header with-border nav-product" id="Titulo_Center">
      <h5 class="box-title"><strong>Productos y servicios</strong></h5>
