        ...
        <div class="col-xs-12">
          ...
          <div class="col-xs-4 pull-righ">
            ...
            <div class="alin_global">
              ...
              <button onclick="EtraerDatosSegunLosParametrosEstablecidos();" class="btn-sm" id="btn_bucar_data"> <em
...
<div class="col-md-12" id="DivSelectEnFases">
  <div class="box box-warning ">
    <div class="box-header with-border titulosclass" id="Titulo_Center">
      <button id="buttNew" class="btn btn-warning" onclick="Nuevo_registro()" style=' display: none;'><em
          class="fa fa-fw fa-plus-circle" title="Generar Notas"></em></button>
    </div>
    <div class="box-body">
      <div id="toasts"></div>
      ...
      <div class="modal-footer">
        ...
        <button id="button_resgist" class="btn btn-primary btn-sm" onclick="Guardar_Registro_Notas()" disabled><em
            id="em_button_icon" class="fa fa-check"><b>&nbsp;Guardar</b></em></button> <button id="cancel_button"
          onclick="Limpiar_cancelar_registro()" type="button" class="btn btn-danger btn-sm" disabled><em
...
async function ShowSelectedCursos() {
  ...
  if (idgrado) {
    listar_Combo_Cursos_grado(idgrado);
  }
}
