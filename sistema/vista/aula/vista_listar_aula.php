    ...
    <div class="box-body">
      <div class="form-group">
        ...
        <div class="modal-footer">
          <button class="btn btn-primary btn-sm" id="btn-register" onclick="registarAula()"><i
              class="fa fa-check"><b>&nbsp;Registrar</b></i></button>
          <button type="button" class="btn btn-default btn-sm" onclick="linpiarregistroAula()"><i
