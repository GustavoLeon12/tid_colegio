    ...
    <form autocomplete="false" id="from" onsubmit="return false" action="#" enctype="multipart/form-data"
      ...
      <div class="box-header with-border titulosclass" id="Titulo_Center">
        ...
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-primary btn-sm" title="" data-original-title="Remove"
            onclick="RegistrarDatosInstitucion();">
          ...
          <div class="col-xs-12">
            ...
            <div class="col-md-4">
              ...
              <ul class="nav nav-stacked">
                ...
                <input type="file" class="form-control" id="logo_seleccionararchivo"
            ...
            <div class="col-md-4">
              ...
              <ul class="nav nav-stacked">
                ...
                <input type="file" class="form-control" id="pais_seleccionararchivo"
                  accept="image/x-png,image/gif,image/jpeg" style="border-radius: 5px;"><br>
            ...
            <div class="col-md-4">
              ...
              <ul class="nav nav-stacked">
                ...
                <input type="file" class="form-control" id="banner_seleccionararchivo"
                  accept="image/x-png,image/gif,image/jpeg" style="border-radius: 5px;"><br>
              </ul>
