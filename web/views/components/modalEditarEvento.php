        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="datetime-local" name="fecha_inicio" id="edit_fecha_inicio" class="form-control">
            </div>
            <div class="col-md-6 mb-3">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="todo_dia" id="edit_todo_dia">
            <label class="form-check-label" for="edit_todo_dia">Todo el día</label>
          </div>
        </div>
