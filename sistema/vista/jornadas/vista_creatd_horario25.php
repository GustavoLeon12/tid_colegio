  ...
  <div class="box box-warning ">
    ...
    <div class="box-header with-border" id="Titulo_Center">
      ...
      <div class="box-tools pull-left">
        <a href="#" onclick="Regresar_listar_Horarios();" style="margin-top: -15px;">&nbsp;<em
            class="fa fa-chevron-circle-left fa-2x" aria-hidden="true" style="color: #3894c9"></em></a>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="col-md-4">
            ...
            <select class="js-example-basic-single" name="state" id="cbm_jornada" style="width:100%;"
          ...
          <div class="col-md-4">
            ...
            <div class="alin_global">
              ...
              <button onclick="Consultar_Horarios_Generados();" class="btn-sm" id="btn_bucar_data"> <em
  ...
  <div class="box box-warning ">
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          foreach ($cursos as $curso){
            ?>
            <div class="external-event  ui-draggable ui-draggable-handle" style="background: #3894c9; color: #ffff;"
              idcurso="<?php echo $curso['idcurso'] ?>" draggable="true"
              ondragstart="event.dataTransfer.setData('text/plain',null)"
              style="margin-bottom: 5px;padding: 5px;border-radius:4px;position: relative;">
              <?php echo $curso['nonbrecurso']; ?>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary btn-sm" id="button_resgist" onclick="Registrar_horario_Clases();"><em
            class="fa fa-check"><b>&nbsp;Guardar</b></em></button>
