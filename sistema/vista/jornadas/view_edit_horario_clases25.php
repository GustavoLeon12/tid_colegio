                ...
                <thead>
                  ...
                  for ($c = 1; $c <= 5; $c++) {
                    ...
                    <td id="td<?php echo $hora['HorJor_id'] . $c; ?>" class="dropzone"
                      ...
                      idhorario="<?php echo $value['idtd'] ?>"><a style='margin-left:4px;' href='javascript:void(0)'
                        onclick="Eliminar_Horas_add('td<?php echo $hora['HorJor_id'] . $c; ?>')"><span class='label'
                          style='background-color:#676e72;'><em
                            class=' fa fa-close'></em></span></a>&nbsp;<?php echo $value['nonbrecurso'] ?></td>
                    <?php
                      }
                    } else {
                      ?>
