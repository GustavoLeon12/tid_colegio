...
<!--
 <div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
      <div id='avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    ...
    <div class="box-header with-border">
      ...
      <div class=" titulosclass">
        ...
        <div class="grup_buttons" style="margin-top: -25px;">
          ...
          <button class="btn btn-primary btn-sm " id="button_resgist" onclick="Registar_Nuevo_Matricula()"><em
              class="fa fa-check"><b>&nbsp;Registrar</b></em></button>&nbsp;<button
            class="btn btn-default btn-sm pull-right" onclick="limpiar_Registro_from()"><em
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-3">
            ...
            <select class="js-example-basic-single" name="state" id="cbm_grado" style="width:100%;"
              onchange="ShowSelectedDetalles(this);">
            </select><br>
          </div>
          <div class="col-md-3">
