...
$MU->Actualizar_New_Alumno($idalumno, $apellp, $nombre, $fechaN, $dni, $telf, $codi, $sexo, $direccion, $tp_docu, $ubigeo, $image);

$consulta = $MU->Actualizar_New_Apoderados($idalumno, $nom_pade, $apell_pade, $dni_pade, $nom_madre, $apell_madre, $dni_madre, $nom_cole, $nom_direc, $cole_codig, $tp_docu_madre, $tp_docu_padre, $ubigeo_madre, $ubigeo_padre);
