    ...
    table_matricula = $("#tabla_matricula").DataTable({
        ...
        "columns": [{
           ...
           {"data": "seccion"},
         {
            ...
            "&nbsp;<button  type='button' class='verformato btn btn-primary btn-sm'><em class='fa  fa-photo' title='ver formato '></em></button>"+
            "&nbsp;<button type='button' class='imprimir btn btn-default btn-sm'  title='imprimir' ><em class='fa fa-print'></em></button>"
