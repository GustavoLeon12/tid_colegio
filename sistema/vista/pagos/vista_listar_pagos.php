...
<div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
  <div id='avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button
    ...
    Todos los cambios realizados solo tendrán efecto en el año académico <strong>activo </strong>. Si se cambia de año
    académico de nuevo volverás a configurar los grados y cursos. Gracias!!
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="col-xs-4">
            ...
            <input type="text" class="global_filter form-control pull-right " id="global_filter"
  ...
  <div class="col-md-8" id='modal_agregar_curso'>
    <div class="box box-warning ">
      ...
      <div class="box-body">
        <div class="col-lg-12">
          ...
          <div class="col-lg-12" style='border-color: #f5c6cb;'>
            <div id="avisomanual" class="alert  sm" role="alert" style="color: #0e0102; background-color: #accbef;">
            ...
            <div class="col-xs-12">
              ...
              <div class="col-xs-4">
                ...
                <div class="alin_global">
                  ...
                  &nbsp;&nbsp;<button onclick="Agregar_tabla_Pagos();" class="btn-sm" id="but_alin_global"> <em
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btn_imprimir_boleta" onclick="Imprimir_Boleta_De_Pago()"
          class="btn bg-navy margin btn-sm" style="display: none;"><strong>¿Deseas Imprimir Boleta de Pago?</strong> <em
            class="fa fa-print"></em></button>&nbsp;
        <button class="btn btn-primary btn-sm " id="btn_registra" onclick="Registrar_Pago_Alumno()"><em
            class="fa fa-check"><b>&nbsp;Registrar</b></em></button>&nbsp;<button class="btn btn-default btn-sm "
          onclick="limpiar_Modal_registro()"><em class="fa fa-close"><b>&nbsp;Cancelar</b></em></button>&nbsp;
      </div>
    </div>
  </div>
            ...
            <div class="box box-widget widget-user-2">
              <div class="widget-user-header bg-widget">
                <div class="widget-user-image">
                  <img class="img-circle" src="../imagenes/images.png" alt="User Avatar">
                </div>
