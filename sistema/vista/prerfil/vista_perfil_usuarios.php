...
<div class="col-md-3 pull-right">
	<div class="box box-warning ">
		<div class="box-body">
			<form autocomplete="false" onsubmit="return false" method="POST" action="#" enctype="multipart/form-data"
				onsubmit="return false">
				<div class="box-body box-profile">
					<img class="profile-user-img img-responsive img-circle img2" onerror="verificarImagen('img2')"
						src="/images.png" alt="User profile picture" id="mostrarimagen">
					...
					<ul class="list-group list-group-unbordered">
						<li class="list-group-item">
							...
							<ul class="nav nav-stacked">
								...
								<input type="file" class="form-control" id="seleccionararchivo"
									accept="image/x-png,image/gif,image/jpeg" style="border-radius: 5px;">
							</ul>
						</li>
						<li class="list-group-item">
							<strong>Contrase&ntilde;a Actual</strong>
							<input type="password" class="form-control" id="txt_act_contra"
								placeholder="Ingrese contrase&ntilde;a Actual" required
						...
						<li class="list-group-item">
							...
							<input type="password" class="form-control" id="txt_cont_nuw"
								placeholder="Ingrese contrase&ntilde;a Nueva" required
								onkeypress="return (event.charCode > 63 &&   event.charCode < 91) ||
						 (event. charCode > 96 && event.charCode < 123)||(event. charCode >34 && event.charCode<39)||(event. charCode>47 && event. charCode<58)||(event. charCode==42)">
						</li>
						<li class="list-group-item">
							<strong>Repita la Contrase&ntilde;a Nueva(*)</strong>
							<input type="password" class="form-control" id="repcontra_contra"
								placeholder="Repita contrase&ntilde;a Repetida" required
								onkeypress="return (event.charCode > 63 &&   event.charCode < 91) ||
						 (event. charCode > 96 && event.charCode < 123)||(event. charCode >34 && event.charCode<39)||(event. charCode>47 && event. charCode<58)||(event. charCode==42)">
						</li>
					</ul>
					<a href="#" onclick="Modificar_Contrasena()" id="butt_regist"
						class="btn btn-primary btn-block"><strong>Actualizar</strong></a>
				</div>
