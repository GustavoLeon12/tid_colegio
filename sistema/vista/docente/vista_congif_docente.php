...
<div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
  <div id='avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button
    ...
    Asignar grados a los docentes para diferentes niveles 1.) seleccione el docente en&nbsp; <em
      class="glyphicon glyphicon-plus "></em> &nbsp; 2.) seleccione grados y agrega a la tabla en &nbsp; + &nbsp;
      ...
      <div class="form-group pull-right">
        <div class="col-lg-10 pull-right">
          <div class="input-group pull-right">
            <input type="text" class="global_filter form-control input-sm pull-right" id="global_filter"
...
<div class="col-md-6" id='modal_agregar_grados' style="display: none;">
  <div class="box box-warning ">
    ...
    <div class="box-body">
      <div class="col-lg-12">
        ...
        <div class="row">
          ...
          <div class="col-xs-2">
            <button class="btn  btn-warning btn-sm" id="add_cursos_btn" onclick="Add_tr_table()" disabled><em
        ...
        <div class="table-responsive">
          <table style="width:100%" class="table table-ms">
            <thead class=" thead-drak" style="color: #ffffff; background-color: #9fa5a4;">
              <th>Orden</th>
              <th>Nombre</th>
              <th>Quitar</th>
            </thead>
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary btn-sm " id="button_resgist" onclick="Registrar_Docente_Grado()"><em
    ...
    <div class="box-body">
      <div class="col-lg-12">
        ...
        <table style="width:100%" class="table table-ms table-responsive">
          <thead class=" thead-drak" style="color: #fff; background-color: #9fa5a4;">
            <th>Orden</th>
            <th>Grado</th>
            <th>Nivel</th>
            <th>seccion</th>
