      ...
      <div class="row">
        <div class="col-xs-4">
          <div class="alin_global">
            ...
            <button onclick="Resito_AsistenciaView();" class="btn btn-primary " name="search" id="but_alin_global"
              class="btn btn-flat">
              <em class="fa fa-plus" style="color: white;"></em>
            </button>&nbsp;
            <button onclick="Editar_AsistenciaView();" class="btn btn-primary " name="search" id="but_alin_global"
              class="btn btn-flat">
              <em class="fa fa-edit" style="color: white;"></em>
            </button>&nbsp;
            <button onclick="Eliminar_AsistenciaView();" class="btn btn-primary " name="search" id="but_alin_global"
              class="btn btn-flat">
  ...
  <div class="box box-warning ">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="col-md-3">
            <label>Fecha</label>
            <div class="alin_global">
              <input class="form-control form-control-sm" type="Date" id="FechaAsistencia">&nbsp;&nbsp;<button
                onclick="Listar_Alumno_Asistencia();" class="btn-sm" id="btn_bucar_data"> <em
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary btn-sm" id="button_resgist" onclick="RegistrarAsistencia()"><em
            class="fa fa-check"><b>&nbsp;Registrar</b></em></button>
      </div>
    </div>
  </div>
</div>
...
<div class="col-md-12" id="EditarDivAsistencia" style="display: none;">
  <div class="box box-warning ">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-xs-12">
          <div class="col-md-3">
            <label>Seleccione Grado</label>
            <select class="js-example-basic-single " name="state" id="edit_cbm_grado" style="width:100%;"
              onchange="ShowSelected_Edit();">
            </select>
          </div>
          <div class="col-md-3">
            <label>Nivel</label>
          ...
          <div class="col-md-3">
            <label>Fecha</label>
            <div class="alin_global">
              <input class="form-control form-control-sm" type="Date" id="SeachFechaEdit"
                style="border-radius: 5px;">&nbsp;&nbsp;<button onclick="Listar_Asistencias_fecha();" class="btn-sm"
                id="edit_btn_bucar_data"> <em class="fa fa-search"></em></button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-footer">
      <img class="loader" src="../Login/vendor/abc.gif" style="width: 50px;height:50px;display: none;">&nbsp;
      <button class="btn btn-primary btn-sm" id="edit_button_resgist" onclick="Update_Asistencia();"><i
...
<div class="col-md-12" id="ElimirarDivAsistencia" style="display: none;">
  <div class="box box-warning ">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-xs-12">
          <div class="col-md-3">
            <label>Seleccione Grado</label>
            <select class="js-example-basic-single " name="state" id="elim_cbm_grado" style="width:100%;"
              onchange="ShowSelected_Elimi();">
            </select>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            ...
            <div class="alin_global">
              <input class="form-control form-control" type="Date" id="FecahaFin"
                style="border-radius: 5px;">&nbsp;&nbsp;<button onclick="Estraer_Asistencia_Eliminar();" class="btn-sm"
                id="elimi_btn_bucar_data"> <em class="fa fa-search"></em></button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-footer">
      <img class="loader" src="../Login/vendor/abc.gif" style="width: 50px;height:50px;display: none;">&nbsp;
      <button class="btn btn-danger btn-sm" id="elim_button_resgist" onclick="Elimirar_Asistencia();"><em
          class="fa fa-trash-o" aria-hidden="true"></em> Eliminar</button>
