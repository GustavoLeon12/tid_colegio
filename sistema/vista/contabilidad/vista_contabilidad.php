          ...
          <div class="info-box bg-orange" style="border-radius: 6px"><span class="info-box-icon"
            ...
            <div class="info-box-content">
              ...
              <div> <a class="small-box-footer" onclick="Summary_exit_entry()"
                  style="color: #f7f5f3;cursor: pointer;font-size: 25px"><strong id="total_summary">S/. 0.00</strong>
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="info-box bg-navy" style="border-radius: 6px"><span class="info-box-icon"
            ...
            <div class="info-box-content">
              ...
              <div> <a class="small-box-footer" style="color: #f39c12;cursor: pointer;font-size: 25px"><strong
                    id="pettycash_summary">S/. 0.00</strong> </a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="box box-warning ">
    ...
    <div class="box-body">
      <div class="box-header">
        <h3 class="box-title"><strong>Resumen general de los ingresos y egresos del año-
            <?php echo date('Y'); ?>
          </strong></h3>
      </div>
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="alin_global">
            ...
            <button onclick="List_pettycash_summary();" class="btn" type="submit" id="but_alin_global"
              class="btn btn-flat">
