...
<div class='col-lg-12' style='border-color: #f5c6cb;' id="tutotiales_Id">
  <div id='avisomanual' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button
    ...
    Para crear un nuevo año académico seleccione en &nbsp; <i class='glyphicon glyphicon-plus '></i> &nbsp; se creara en
    forma “inactivo” solo debes tener un año académico Activo no se permite mas Gracias..!!
...
<div class='col-lg-12' style='border-color: #f5c6cb;display: none; ' id="Cerat_avisomanual">
  <div id='' class='alert  sm' role='alert' style='color: #0e0102; background-color: #accbef;'><button type="button"
      class="close" data-dismiss="alert" aria-hidden="true">×</button>
    Para crear Año académico correctamente sigue este mensaje : llene las fecha en forma ascendente ..en seguida
    seleccione el año ..seleccione turno las que deseas tener en este año y ingresa horas(de forma ascendente)
    académicas para cada turno (ejemplo 08:00am - 13pm). ¡¡¡Las hora y turnos serán para jornadas laborales …Suerte!!!
  </div>
</div>
    ...
    <div class="box-body">
      <div class="box-body">
          ...
          <div class="col-xs-12">
            <div id="cont_error" class="form-group">
              <div class="col-md-4">
                ...
                <input type="date" class="form-control" id="YearFechainicio" style="border-radius: 5px;" required
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary btn-sm" id="button_resgist" onclick="RegisUpdat_YearEscolar();"><i
              class="fa fa-check"><b>&nbsp;Guardar</b></i></button>

          <button type="button" class="btn btn-danger btn-sm" onclick="LimpiarRegistroYear()"><i
        ...
        <div class="col-xs-8 pull-right">
          <div class="alin_global">
            <input type="text" class="global_filter form-control " id="global_filter"
              placeholder="Ingresar dato a buscar" style="border-radius: 5px; width: 100%">&nbsp;&nbsp;<button
