...
if ($result == 0) {
	$result = $MU->Registrar_Docente($nombreDocente, $apellidDocente, $dniDocente, $emailDocente, $telfDocente, $codigDocente, $nivelDocente, $tipoDocente, $ubigeo, $tipoDocumento, $image, $facebook);
	echo $result;
} else {
	echo 100;
}
