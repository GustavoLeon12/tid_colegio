...
class Docente
{
  ...
  function Actualizar_Docente($nombreDocente, $apellidDocente, $dniDocente, $emailDocente, $telfDocente, $codigDocente, $nivelDocente, $tipoDocente, $idDocente, $ubigeo, $tipoDocumento, $image, $facebook)
  {
    if ($image == "") {
      $sql = "update docentes set nombres='$nombreDocente',apellidos='$apellidDocente',dni='$dniDocente',email='$emailDocente',telefono='$telfDocente',codigo='$codigDocente',tipo_docente='$tipoDocente', nivelId='$nivelDocente',updateDate= NOW(), fk_ubigeo='$ubigeo', fk_docu='$tipoDocumento', facebook='$facebook' where id_docente='$idDocente' ";
      if ($consulta = $this->conexion->conexion->query($sql)) {
        return 1;
      ...
      $sql = "update docentes set nombres='$nombreDocente',apellidos='$apellidDocente',dni='$dniDocente',email='$emailDocente',telefono='$telfDocente',codigo='$codigDocente',tipo_docente='$tipoDocente', nivelId='$nivelDocente',updateDate= NOW(), fk_ubigeo='$ubigeo', fk_docu='$tipoDocumento', docente_foto='$image' where id_docente='$idDocente' ";
      if ($consulta = $this->conexion->conexion->query($sql)) {
        return 1;
  ...
  function Registrar_Docente($nombreDocente, $apellidDocente, $dniDocente, $emailDocente, $telfDocente, $codigDocente, $nivelDocente, $tipoDocente, $ubigeo, $tipoDocumento, $image, $facebook)
  {
    $sql = "INSERT INTO docentes(nombres,apellidos,dni,email,telefono,codigo,rolDocente,tipo_docente, nivelId,createDate, fk_ubigeo, fk_docu, docente_foto, facebook)
  VALUES ('$nombreDocente','$apellidDocente','$dniDocente','$emailDocente','$telfDocente','$codigDocente','2','$tipoDocente','$nivelDocente',NOW(), '$ubigeo', '$tipoDocumento', '$image', '$facebook')";
    if ($consulta = $this->conexion->conexion->query($sql)) {
      return 1;
    } else {
      return 0;
...
////////////////////////////////////////////////////////////////
 ...
 where idDocente='$iddocente'  and idyear='$yearid' and idGrado='$gradoId'";
  ...
  {
    $sql = "select idCursos,nonbrecurso,cursoCodigo,idGrado,Seccion FROM docente_curso
    inner join  curso on curso.idcurso = docente_curso.idCursos
